...
TEST_CASES = [
    ...
    Case(nums=range(0, 10**9, 2), value=10**9 - 2, result=True, name="max_in_big_range"),
    Case(nums=range(0, 10**9, 2), value=0, result=True, name="min_in_big_range"),
    Case(nums=range(0, 10**9, 2), value=10**9, result=False, name="greater_than_max_in_big_range"),
    Case(nums=range(0, 10**9, 2), value=-1, result=False, name="less_than_min_in_big_range"),
    Case(nums=range(0, 10**9, 2), value=10**9 // 2, result=True, name="middle_in_big_range"),
    Case(nums=range(0, 10**9, 2), value=10**9 // 2 + 1, result=False, name="middle_not_exists_in_big_range"),
]
